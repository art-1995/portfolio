...
function Main(){
  ...
  //     document.getElementById('slideNav').classList.add('active');
  //     document.getElementById('slideOne').classList.add('active');
  //     document.getElementById('slideTwo').classList.add('active');
  //   }
  ...
  return(
    <div className='main container'>
      <nav className={`slide_nav ${closeList ? 'active' : ''}`}>
