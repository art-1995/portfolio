...
import { ReactComponent as Aboutimg } from '../public/img/about.svg';

function About(){
    return(
        <div className='about pdd_top content container'>
                    ...
                    <div className='article_box2'>
                        ...
                        <div className='flex'>
                            <div className='left'>
                                ...
                                <div className='article_box'>
                                    <h6 className='date_title'>2019.03 ~ 2021.03</h6>
                                    <p className='sub_title'>미술학과</p>
                                    <p className='sub_article'>충남대학교 일반대학원</p>
                                </div>
                                <div className='article_box'>
                                    <h6 className='date_title'>2014.03 ~ 2019.02</h6>
                                    <p className='sub_title'>회화과 한국화전공</p>
                                    <p className='sub_article'>충남대학교</p>
                                </div>
                            </div>
                            <div className='right'>
                                <div className='article_box'>
                                    <h6 className='date_title'>2016.09</h6>
                                    <p className='sub_title'>Adobe Illustrator</p>
                                    <p className='sub_article'>ADOBE</p>
                                </div>
                                <div className='article_box'>
                                    <h6 className='date_title'>2016.02</h6>
                                    <p className='sub_title'>GTQ포토샵1급</p>
                                    <p className='sub_article'>한국생산성본부(KPC)</p>
                                </div>
                            </div>
                        </div>
                    </div>
