    ...
    return(
        <div className='about pdd-top content container'>
            <div className='article-title'>
                <p className='article-title-txt title-ft'>ABOUT</p>
            ...
            <div className='article-wrap flex'>
                ...
                <div className='article-box-wrap'>
                    <div className='article-box'>
                        ...
                        <p className='sub-title'>정서린 SEO-LYNN JEONG</p>
                        <p className='article'>
                    ...
                    <div className='article-box'>
                        ...
                        <h6 className='date-title'>2021.07 ~</h6>
                        <p className='sub-title'>(주)디벨록 정보전산실 프론트엔드 디자이너 주임</p>
                    ...
                    <div className='article-box2'>
                        ...
                        <div className='flex'>
                            <div className='left'>
                                <div className='article-box'>
                                    <h6 className='date-title'>2021.01 ~ 2021.06</h6>
                                    <p className='sub-title'>웹 디자인&퍼블리싱 교육 이수</p>
                                    <p className='sub-article'>SBS 컴퓨터 아카데미</p>
                                </div>
                                <div className='article-box'>
                                    <h6 className='date-title'>2019.03 ~ 2021.03</h6>
                                    <p className='sub-title'>미술학과</p>
                                    <p className='sub-article'>충남대학교 일반대학원</p>
                                </div>
                                <div className='article-box'>
                                    <h6 className='date-title'>2014.03 ~ 2019.02</h6>
                                    <p className='sub-title'>회화과 한국화전공</p>
                                    <p className='sub-article'>충남대학교</p>
                                </div>
                            </div>
                            <div className='right'>
                                <div className='article-box'>
                                    <h6 className='date-title'>2016.09</h6>
                                    <p className='sub-title'>Adobe Illustrator</p>
                                    <p className='sub-article'>ADOBE</p>
                                </div>
                                <div className='article-box'>
                                    <h6 className='date-title'>2016.02</h6>
                                    <p className='sub-title'>GTQ포토샵1급</p>
