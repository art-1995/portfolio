...
function Nav(){
  ...
  return(
    <nav className='nav_var container titleFt flex align-center'>
      <Link to='/'>HOME</Link>
      <Link to='/about'className={"btn " + (this.state.isOn ? 'btn-dark' : 'btn-light')} onClick={this.handleToggle}>
      {this.state.isOn ? 'On' : 'Off'}ABOUT</Link>
      <Link to='/work'>WORK</Link>
      <Link to='/contect'>CONTECT</Link>
    </nav>
  )
