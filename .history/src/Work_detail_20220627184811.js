        ...
        <div className='work_detail'>
            ...
            <div className='container detail_content flex'>
                ...
                <div className='detail_info'>
                    <div className='top'>
                        <div className='flex'>
                            <h5 className='title'>{workData.title}</h5>
                            <p className='sub_title'>{workData.subtitle}</p>
                        </div>
                        <p className='contrib'>{workData.contribution}</p>
                    </div>
                    <div className='explain'>{workData.content}</div>
                </div>
            </div>
